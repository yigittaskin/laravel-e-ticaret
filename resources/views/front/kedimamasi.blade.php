...
@section('title') Kedi Maması @endsection
@section('content')

    <div class="page-head_agile_info_w3l">
        <div class="container">
            <h3>Kedi Maması<span></span></h3>
            <!--/w3_short-->
            ...
            <div class="col-md-4 products-left">
                ...
                <div class="css-treeview">
                    ...
                    <ul class="tree-list-pad">
                        ...
                        @endforeach
                        {{--<li><input type="checkbox" checked="checked" id="item-0" /><label for="item-0"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Royal Canin</label></li>
                        <li><input type="checkbox" id="item-1" checked="checked" /><label for="item-1"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> ProPlan</label></li>
                        <li><input type="checkbox" checked="checked" id="item-2" /><label for="item-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> ProLine</label>
                        <li><input type="checkbox" id="item-2-2" /><label for="item-2-2"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> Whiskas</label>
                        </li>--}}
                    </ul>
                </div>
